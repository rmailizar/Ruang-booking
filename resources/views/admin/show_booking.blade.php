...
<div class="content-wrapper">
    ...
    <form action="{{ route('bookings.export') }}" method="GET" class="mb-3">
        <div class="row g-2 align-items-end">
            <div class="col">
                <label for="start_date" class="form-label fs-6 badge text-bg-primary rounded fw-bold text-white">Dari Tanggal:</label>
                <input type="date" name="start_date" id="start_date" class="form-control" placeholder="Dari Tanggal">
            </div>
            <div class="col">
                <label for="end_date" class="form-label fs-6 badge text-bg-primary rounded fw-bold text-white">Sampai Tanggal:</label>
